    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item"><a class="nav-link px-3" href="homestays.php">Homestays</a></li>
                ...
                <li class="nav-item ms-lg-3">
                    <a href="owner/login.php" class="btn btn-accent-custom btn-sm">List Your Property</a>
                </li>
            </ul>
        </div>
    </div>
